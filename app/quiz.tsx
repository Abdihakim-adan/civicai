  ...
  devolution: [
    {
      ...
      options: ['42', '47', '52', '37'],
      correct_answer: '47',
      explanation: 'Kenya has 47 counties established under the Constitution of Kenya 2010.',
    },
    {
      id: 2,
      question: 'Who is the head of a county government?',
      options: ['County Commissioner', 'County Governor', 'County Speaker', 'Senator'],
      correct_answer: 'County Governor',
      explanation: 'Article 180 establishes the county governor as the chief executive of the county.',
    },
    {
      id: 3,
      question: 'What is the legislative arm of the county government called?',
      options: ['County Parliament', 'County Assembly', 'County Council', 'County Senate'],
      correct_answer: 'County Assembly',
      explanation: 'Each county has a County Assembly responsible for legislation and oversight.',
    },
    {
      id: 4,
      question: 'Which article of the Constitution establishes devolution?',
      options: ['Article 174', 'Article 180', 'Article 190', 'Article 200'],
      correct_answer: 'Article 174',
      explanation: 'Article 174 outlines the objects and principles of devolved government.',
    },
    {
      id: 5,
      question: 'How often are county governors elected?',
      options: ['Every 3 years', 'Every 5 years', 'Every 4 years', 'Every 7 years'],
      correct_answer: 'Every 5 years',
      explanation: 'County governors serve a term of five years and are eligible for re-election.',
    },
    {
      id: 6,
      question: 'What is the capital city county of Kenya?',
      options: ['Mombasa County', 'Nairobi City County', 'Kisumu County', 'Nakuru County'],
      correct_answer: 'Nairobi City County',
      explanation: 'Nairobi City County serves as the capital and is the most populous county.',
    },
    {
      id: 7,
      question: 'Which body oversees county government finances?',
      options: ['County Treasury', 'Office of the Auditor-General', 'Controller of Budget', 'All of the above'],
      correct_answer: 'All of the above',
      explanation: 'Multiple bodies oversee county finances including the Auditor-General and Controller of Budget.',
    },
    {
      id: 8,
      question: 'What is the minimum number of counties required for a referendum?',
      options: ['24 counties', '30 counties', '15 counties', '47 counties'],
      correct_answer: '24 counties',
      explanation: 'A constitutional amendment through popular initiative requires support from at least 24 counties.',
    },
  ],
  'government-services': [
    {
      id: 1,
      question: 'What is the eCitizen portal used for?',
      options: ['Social media', 'Accessing government services online', 'Online shopping', 'Gaming'],
      correct_answer: 'Accessing government services online',
      explanation: 'eCitizen is Kenya\'s official digital platform for accessing government services.',
    },
    {
      id: 2,
      question: 'Which document is required to apply for a Kenyan passport?',
      options: ['Birth Certificate and National ID', 'Driving License', 'School Certificate', 'Bank Statement'],
      correct_answer: 'Birth Certificate and National ID',
      explanation: 'A birth certificate and national ID are primary requirements for passport applications.',
    },
    {
      id: 3,
      question: 'What does KRA PIN stand for?',
      options: ['Kenya Revenue Authority Personal Identification Number', 'Kenya Registration Authority Personal Identity Number', 'Kenya Roads Authority Personal Identification Number', 'Kenya Rural Administration Personal Identification Number'],
      correct_answer: 'Kenya Revenue Authority Personal Identification Number',
      explanation: 'KRA PIN is a unique number issued by the Kenya Revenue Authority for tax purposes.',
    },
    {
      id: 4,
      question: 'Where do you apply for a business registration in Kenya?',
      options: ['County Office', 'Business Registration Service', 'Ministry of Foreign Affairs', 'Police Station'],
      correct_answer: 'Business Registration Service',
      explanation: 'The Business Registration Service handles company and business name registration.',
    },
    {
      id: 5,
      question: 'What is NHIF?',
      options: ['National Housing Insurance Fund', 'National Health Insurance Fund', 'National Highway Infrastructure Fund', 'National Heritage Insurance Fund'],
      correct_answer: 'National Health Insurance Fund',
      explanation: 'NHIF provides health insurance coverage to Kenyan citizens and residents.',
    },
    {
      id: 6,
      question: 'Which body issues driving licenses in Kenya?',
      options: ['Kenya Police', 'NTSA', 'Ministry of Transport', 'County Government'],
      correct_answer: 'NTSA',
      explanation: 'The National Transport and Safety Authority (NTSA) issues driving licenses.',
    },
    {
      id: 7,
      question: 'What is the official identification document for Kenyan citizens?',
      options: ['Passport', 'National ID Card', 'Driving License', 'Birth Certificate'],
      correct_answer: 'National ID Card',
      explanation: 'The National ID Card is the primary identification document for Kenyan citizens.',
    },
    {
      id: 8,
      question: 'How can citizens access HELB loans?',
      options: ['Through banks only', 'Through the HELB online portal', 'Through universities only', 'Through county offices'],
      correct_answer: 'Through the HELB online portal',
      explanation: 'The Higher Education Loans Board provides loans through its online portal.',
    },
  ],
  leadership: [
    {
      id: 1,
      question: 'Which chapter of the Constitution covers leadership and integrity?',
      options: ['Chapter Four', 'Chapter Six', 'Chapter Eight', 'Chapter Ten'],
      correct_answer: 'Chapter Six',
      explanation: 'Chapter Six of the Constitution addresses leadership and integrity.',
    },
    {
      id: 2,
      question: 'What is the term limit for the President of Kenya?',
      options: ['One term', 'Two terms', 'Three terms', 'No limit'],
      correct_answer: 'Two terms',
      explanation: 'The President can serve a maximum of two five-year terms.',
    },
    {
      id: 3,
      question: 'Who is responsible for appointing Cabinet Secretaries?',
      options: ['Parliament', 'The President', 'The Judiciary', 'The Senate'],
    ...
    {
      id: 4,
      question: 'Which body investigates complaints against public officers?',
      options: ['The Police', 'The Ethics and Anti-Corruption Commission', 'The Judiciary', 'Parliament'],
      correct_answer: 'The Ethics and Anti-Corruption Commission',
      explanation: 'EACC investigates corruption and ethical violations by public officers.',
    },
    {
      id: 5,
      question: 'What is the minimum age requirement to be President of Kenya?',
      options: ['25 years', '30 years', '35 years', '40 years'],
      correct_answer: '35 years',
      explanation: 'A person must be at least 35 years old to be eligible for the presidency.',
    },
    {
      id: 6,
      question: 'Which principle requires leaders to declare their wealth?',
      options: ['Accountability', 'Transparency', 'Integrity', 'All of the above'],
      correct_answer: 'All of the above',
      explanation: 'Leaders must declare their wealth as part of accountability, transparency, and integrity requirements.',
    },
    {
      id: 7,
      question: 'Who is the head of the Public Service?',
      options: ['The President', 'The Public Service Commission Chairperson', 'The Cabinet Secretary', 'The Attorney General'],
      correct_answer: 'The Public Service Commission Chairperson',
      explanation: 'The Public Service Commission is headed by a chairperson who oversees the public service.',
    },
    {
      id: 8,
      question: 'What happens if a State officer violates Chapter Six?',
      options: ['Nothing', 'They can be removed from office', 'They receive a warning', 'They pay a fine'],
      correct_answer: 'They can be removed from office',
      explanation: 'Violation of Chapter Six can lead to removal from office through established procedures.',
    },
  ],
  'national-values': [
    {
      id: 1,
      question: 'Which article lists the national values and principles of governance?',
      options: ['Article 10', 'Article 20', 'Article 30', 'Article 40'],
      correct_answer: 'Article 10',
      explanation: 'Article 10 outlines national values including patriotism, democracy, and social justice.',
    },
    {
      id: 2,
      question: 'Which of these is a national value in Kenya?',
      options: ['Individualism', 'Patriotism', 'Competition', 'Isolation'],
      correct_answer: 'Patriotism',
      explanation: 'Patriotism is one of the national values listed in Article 10.',
    },
    {
      id: 3,
      question: 'What does "Harambee" mean as a national value?',
      options: ['Competition', 'Pulling together', 'Individual achievement', 'Government control'],
      correct_answer: 'Pulling together',
      explanation: 'Harambee represents the spirit of pulling together for community development.',
    },
    {
      id: 4,
      question: 'Which principle ensures all Kenyans are treated equally?',
      options: ['Devolution', 'Rule of law', 'Non-discrimination', 'Federalism'],
      correct_answer: 'Non-discrimination',
      explanation: 'Non-discrimination ensures equal treatment regardless of background or status.',
    },
    {
      id: 5,
      question: 'What does sustainable development as a national value mean?',
      options: ['Rapid industrialization', 'Meeting present needs without compromising future generations', 'Maximum resource extraction', 'Urban development only'],
      correct_answer: 'Meeting present needs without compromising future generations',
      explanation: 'Sustainable development balances current needs with environmental and future considerations.',
    },
    {
      id: 6,
      question: 'Which value promotes citizen participation in governance?',
      options: ['Democracy', 'Autocracy', 'Oligarchy', 'Monarchy'],
      correct_answer: 'Democracy',
      explanation: 'Democracy ensures citizens participate in decision-making processes.',
    },
    {
      id: 7,
      question: 'What does social justice as a national value ensure?',
      options: ['Equal distribution of wealth', 'Fair treatment and equitable sharing of resources', 'Free education only', 'Healthcare for the rich'],
      correct_answer: 'Fair treatment and equitable sharing of resources',
      explanation: 'Social justice ensures fair treatment and equitable access to resources and opportunities.',
    },
    {
      id: 8,
      question: 'Who is bound by national values and principles?',
      options: ['Only government officials', 'All State organs, State officers, and public officers', 'Only the President', 'Only citizens'],
      correct_answer: 'All State organs, State officers, and public officers',
      explanation: 'Article 10 binds all State organs, State officers, and public officers when applying the Constitution.',
    },
  ],
};
...
export default function QuizScreen() {
  ...
  if (showResults && score !== null) {
    return (
      <SafeAreaView style={[styles.container, styles.resultsContainer]} edges={['top']}>
        <StatusBar barStyle="dark-content" backgroundColor="#F8FAFC" />
